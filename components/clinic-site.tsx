...
export function ClinicSite() {
  ...
  return (
    <main>
      ...
      <footer className="homepage-footer" id="locations"><div className="shell footer-grid"><div><Link className="footer-brand" href="/" aria-label="Mission Primary Care home"><Image src={LOGO_SRC} alt={LOGO_ALT} width={104} height={104} /></Link><p>Care for your whole health, close to home.</p></div><div><strong>Explore</strong><Link href="/services">Care & services</Link><Link href="/providers">Our providers</Link><Link href="/new-patients">New patients</Link><Link href="/insurance">Insurance</Link><Link href="/wellness-shop">Wellness shop</Link><Link href="/about">About Mission</Link></div><div><strong>Get in touch</strong><Link href="/contact">Find a location</Link><a href="tel:18005550140">{PHONE}</a><a href="mailto:hello@missionprimarycare.com">hello@missionprimarycare.com</a></div><div><strong>Stay in the know</strong><p>Healthy insights, delivered monthly.</p><div className="email-input"><input aria-label="Email address" placeholder="Email address" /><button aria-label="Subscribe"><ArrowRight size={17} /></button></div></div></div><div className="shell footer-bottom"><span>© 2026 Mission Primary Care</span><span>Privacy · Accessibility · Terms</span></div></footer>
