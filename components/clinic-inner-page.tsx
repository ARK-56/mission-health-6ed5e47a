...
const imageByPage: Record<PageKind, string> = { services: '/clinic-care.png', 'new-patients': '/clinic-care.png', providers: '/team/care-team.webp', insurance: '/insurance-plans.png', resources: '/clinic-wellness.png', about: '/team/about-team.webp', contact: '/clinic-care.png' }
