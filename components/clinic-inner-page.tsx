...
const imageByPage: Record<PageKind, string> = { services: '/clinic-care.png', 'new-patients': '/new-patient-form.png', providers: '/team/care-team.webp', insurance: '/insurance-plans.png', resources: '/clinic-wellness.png', about: '/clinic-reception.png', contact: '/clinic-care.png' }
