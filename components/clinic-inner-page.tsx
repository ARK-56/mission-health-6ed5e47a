...
type Block =
  ...
  | 'locations' | 'content' | 'highlight' | 'cta' | 'innerCta'
...
const layouts: Record<PageKind, Block[]> = {
  ...
  about: ['story', 'content', 'providers', 'highlight', 'locations', 'testimonial', 'cta'],
  contact: ['locations', 'content', 'faq', 'trust', 'providers', 'resources', 'innerCta'],
}
