    ...
    <div className={showLeadership ? 'providers-layout' : 'providers-layout is-solo'}>
      {showLeadership && (
        <figure className="team-panel" data-aos="fade-up">  
          ...
          <img src="/team/zia-portrait.jpg" alt="" width={1086} height={1448} loading="lazy" decoding="async" />  
